...
public class Correlogram_MQTT_40 {

	private static BufferedReader delete,put,get;

	public static void main(String[] args) throws IOException {
		delete = new BufferedReader(new FileReader("/home/paridhika/git/MQTT_Parking/mosquitto/Results/run1/40/delete_simulation_service_time_40_run1.csv"));
		put = new BufferedReader(new FileReader("/home/paridhika/git/MQTT_Parking/mosquitto/Results/run1/40/put_simulation_service_time_40_run1.csv"));
		get = new BufferedReader(new FileReader("/home/paridhika/git/MQTT_Parking/mosquitto/Results/run1/40/get_simulation_service_time_40_run1.csv"));
		...
		/*FileWriter correlation = new FileWriter("/home/paridhika/git/MQTT_Parking/mosquitto/Results/Correlogram_40.csv");
