...
public class Correlogram_XMPP_20 {

	private static BufferedReader delete,put,get;

	public static void main(String[] args) throws IOException {
		delete = new BufferedReader(new FileReader("/home/paridhika/git/XMPP_Parking/Smack-master/smack-tcp/src/main/java/org/jivesoftware/smack/tcp/Results/run_final/20/delete_simulation_service_time_20_run1.csv"));
		put = new BufferedReader(new FileReader("/home/paridhika/git/XMPP_Parking/Smack-master/smack-tcp/src/main/java/org/jivesoftware/smack/tcp/Results/run_final/20/put_simulation_service_time_20_run1.csv"));
		get = new BufferedReader(new FileReader("/home/paridhika/git/XMPP_Parking/Smack-master/smack-tcp/src/main/java/org/jivesoftware/smack/tcp/Results/run_final/20/get_simulation_service_time_20_run1.csv"));
		...
		FileWriter correlation = new FileWriter("/home/paridhika/git/XMPP_Parking/Smack-master/smack-tcp/src/main/java/org/jivesoftware/smack/tcp/Results/Correlogram_20.csv");
