...
public class Correlogram_MQTTWS_60 {

	private static BufferedReader delete,put,get;

	public static void main(String[] args) throws IOException {
		delete = new BufferedReader(new FileReader("/home/paridhika/git/MQTTWS_Parking/paho.mqtt.python/Results/run1/60/delete_simulation_service_time_60_run1.csv"));
		put = new BufferedReader(new FileReader("/home/paridhika/git/MQTTWS_Parking/paho.mqtt.python/Results/run1/60/put_simulation_service_time_60_run1.csv"));
		get = new BufferedReader(new FileReader("/home/paridhika/git/MQTTWS_Parking/paho.mqtt.python/Results/run1/60/get_simulation_service_time_60_run1.csv"));
		...
		FileWriter correlation = new FileWriter("/home/paridhika/git/MQTTWS_Parking/paho.mqtt.python/Results/Correlogram_60.csv");
